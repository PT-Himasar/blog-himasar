...
<div class="bread-crumb">
  <div class="container">
    <div class="text"><a href="{{ route('index') }}">Home</a><i class="fa fa-angle-right"></i> Our Blog
      ...
      <div class="col-md-8 col-sm-12 col-xs-12 content-side">
        <div class="blog-content">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 news-colmun">
              <div class="single-item wow fadeInUp animated animated">
                ...
                <div class="news-content">
                  ...
                  <h4><a href="{{ route('blog-details', ['id' => $row->id]) }}">{{ ucwords(strtolower($row->judul)) }}</a></h4>
                </div>
              </div>
            </div>
            @endforeach
          ...
          <ul class="link-btn">
            ...
            @else
            <li><a href="{{ $blog->previousPageUrl() }}"><i class="fa fa-angle-left"></i></a></li>
            @endif
            ...
            @for ($i = max(1, $currentPage - 1); $i <= min($lastPage, $currentPage + 1); $i++)
              <li>
              <a href="{{ $blog->url($i) }}" class="{{ $currentPage == $i ? 'active' : '' }}">{{ $i }}</a>
              </li>
              @endfor

              {{-- Next Page Link --}}
              @if ($blog->hasMorePages())
              <li><a href="{{ $blog->nextPageUrl() }}"><i class="fa fa-angle-right"></i></a></li>
              @else
