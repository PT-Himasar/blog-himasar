            ...
            <nav class="main-menu">
              ...
              <div class="navbar-collapse collapse clearfix">
                <ul class="navigation clearfix">
                  ...
                  <li class="dropdown {{ request()->is('structure') || request()->is('gallery') || request()->is('faq') || request()->is('error') ? 'current' : '' }}">
                    <a href="#">Structure</a>
                    <ul>
                      <li class="{{ request()->routeIs('structure') ? 'current' : '' }}"><a href="{{ route('structure') }}">Structure Team</a></li>
                      <li class="{{ request()->routeIs('gallery') ? 'current' : '' }}"><a href="{{ route('gallery') }}">Gallery</a></li>
                    </ul>
                  </li>
                  <li class="dropdown {{ request()->is('our-blog') || request()->is('blog-details') ? 'current' : '' }}">
                    <a href="#">Posts</a>
                    <ul>
                      <li class="{{ request()->routeIs('our-blog') ? 'current' : '' }}"><a href="{{ route('our-blog') }}">Blog</a></li>
                      <li class="{{ request()->routeIs('our-event') ? 'current' : '' }}"><a href="{{ route('our-event') }}">Event</a></li>
                    </ul>
                  </li>
