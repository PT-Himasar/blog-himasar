<div class="modal fade" id="demisioner{{ $row -> id }}" data-bs-backdrop="static" tabindex="-1">
    ...
    <form class="modal-content">
      ...
      <div class="modal-body overflow-auto">
        <div class="row justify-content-center">
          ...
          <span class="badge bg-label-danger me-1 col-md-7">
            <b>
              NRA.{{ strtoupper($row->nra) }}.{{ strtoupper($row->patondro) }}.
              @php
              $duaAngkaTerakhir = substr($row->angkatan, -2);
              @endphp
              {{ $duaAngkaTerakhir }}.HIMASAR
            </b>
        ...
        <div class="table-responsive">
          <table class="table text-start" style="white-space: nowrap;">
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                <td>Jenjang Karir</td>
                <td class="text-wrap">: {!! nl2br(e($row->jkarir)) !!}</td>
              </tr>
              <tr>
                <td>Alamat</td>
