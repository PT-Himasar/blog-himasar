        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td class="whitespace-nowrap py-4 px-3 text-center text-sm font-medium">
              <a><i class="bx bx-detail me-0.5" data-bs-toggle="modal" data-bs-target="#mantum{{ $row -> id }}"></i></a>
              ...
              @include('content.users.detail/detail-mantum')
